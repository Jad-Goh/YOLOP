...
from lib.models.common import Conv, SPP, Bottleneck, BottleneckCSP, Focus, Concat, Detect, SharpenConv, C3, C3CBAM, \
    ELANBlock, DownSample, ELANBlock2, DownSample2, SPPCSPC, TransConv, MCB, MCB2
...
YOLOv7 = [
    ...
    # [ -1, BottleneckCSP, [64, 64, 1]],  #2
    # [ -1, Conv, [64, 128, 3, 2]],   #3
    [-1, ELANBlock, [64, 128]],  # 2
    [-1, DownSample, [128]],  # 3
    # [ -1, BottleneckCSP, [128, 128, 3]],    #4
    # [ -1, Conv, [128, 256, 3, 2]],  #5
    [-1, ELANBlock, [128, 256]],  # 4
    [-1, DownSample, [256]],  # 5
    [-1, BottleneckCSP, [256, 256, 3]],  # 6
    [-1, Conv, [256, 512, 3, 2]],  # 7
    [-1, SPP, [512, 512, [5, 9, 13]]],  # 8
...
def get_net(cfg, **kwargs):
    m_block_cfg = PRPNet_MCB  # YOLOPmulti, YOLOPCC3CBAM
...
if __name__ == "__main__":
    ...
    gt_ = torch.rand((1, 2, 64, 64))  # 256, 256
